...
const Works = () => {
  ...
  return (
    <section className="py-20 px-6 mt-20 transition-colors duration-300 bg-transparent">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {steps.map((item, i) => (
            <motion.div
              key={i}
              className="p-6 rounded-xl bg-gray-100 dark:bg-gray-800 transition-all duration-300 hover:scale-105 hover:shadow-lg cursor-pointer"
